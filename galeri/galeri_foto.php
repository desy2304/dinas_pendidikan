...
<head>
    ...
    <style>
        ...
        #editGaleriModal .modal-header {
            background-color: #162F55; color: #fff;
        }

        #tambahGaleriModal .modal-header .close,
        #editGaleriModal .modal-header .close {
...
<body id="page-top">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown">
                            ...
                            <img class="img-profile rounded-circle" src="../uploads/undraw_profile.svg">
                        </a>
    ...
    function openEditGaleri(btn) {
        ...
        document.getElementById('edit-gambar-preview').src = d.gambar || '../uploads/undraw_posting_photo.svg';
