...
<head>
    ...
    <style>
        ...
        .btn-primary:hover { background-color: #162F55 !important; border-color: #162F55 !important; }

        /* Card stat */
        .stat-card { border-left: 4px solid #162F55; }
        ...
        /* Gambar thumbnail tabel */
        .img-thumb { width: 70px; height: 50px; object-fit: cover; border-radius: 6px; background: #f0f0f0; }
        .img-thumb-placeholder { width: 70px; height: 50px; background: #e9ecef; border-radius: 6px; display: flex; align-items: center; justify-content: center; color: #adb5bd; font-size: 20px; }

        /* Form panel */
        .form-panel { border-left: 4px solid #162F55; }

        /* Preview gambar */
        #previewGambar { max-width: 100%; max-height: 200px; object-fit: cover; border-radius: 8px; display: none; margin-top: 8px; }
        #previewGambarEdit { max-width: 100%; max-height: 200px; object-fit: cover; border-radius: 8px; margin-top: 8px; }
...
// Tombol Hapus â€” isi modal hapus
