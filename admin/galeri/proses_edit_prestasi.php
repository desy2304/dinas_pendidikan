...
// Ambil data lama -- sekaligus pastikan baris ini memang kategori prestasi
...
// ==== Upload foto baru (opsional, replace yang lama jika ada) ====
...
$sql = "UPDATE galeri SET
            ...
            gambar = '$gambarEsc'
        WHERE id = $id AND kategori = 'prestasi'";

if (mysqli_query($koneksi, $sql)) {
    header("Location: galeri_prestasi.php?notif=sukses_edit");
} else {
